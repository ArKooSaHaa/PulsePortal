...
If you are on PHP 8.3 and Composer fails due lockfile constraints, use:
...
> If you prefer MySQL instead of SQLite, update `.env` accordingly and run migrations again.
