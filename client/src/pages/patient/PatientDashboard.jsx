...
function ActionCard({ icon: Icon, title, description, label, onClick }) {
    return (
        <motion.div
            whileHover={{
                y: -3,
            ...
            onClick={onClick}
            className="flex flex-col gap-3 bg-white/90 rounded-3xl p-6 shadow-sm border border-slate-100 cursor-pointer select-none"
        >
            <div
            ...
            <button className="mt-auto self-start flex items-center gap-1 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-1 px-3 text-xs border border-blue-500 hover:border-transparent rounded-full transition-colors">
                        ...
                        <div className="flex">
                            ...
                            <div className="flex-1 p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-blue-50 text-[#127fec] text-[11px] font-semibold uppercase tracking-wide">
                                        {UPCOMING.status}
                                    </span>
                                ...
                                <div className="flex flex-wrap gap-2 mt-4">
                                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 me-2 rounded-full bg-slate-100 text-slate-600 text-xs font-medium">
                                        <CalendarDays
                                            size={13}
                                ...
                                <div className="flex items-center gap-3 mt-4">
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.96 }}
                                        className="px-4 py-2 rounded-xl text-sm font-semibold text-white shadow-md focus:outline-none"
                                        style={{
                                            background:
